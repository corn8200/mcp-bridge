...
const OVERSEER_URL = process.env.MCP_BRIDGE_OVERSEER_URL ?? "https://cp.jcornelius.net/mcp/overseer";
...
const SENTINEL_COMMAND =
  process.env.MCP_BRIDGE_SENTINEL_COMMAND ?? "/Users/johncornelius/.claude/mcp-servers/sentinel/run-v2.sh";
